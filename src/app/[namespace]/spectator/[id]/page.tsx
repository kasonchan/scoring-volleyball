    ...
    return (
      <>
        ...
        <main className="mx-auto max-w-4xl flex-1 px-4 py-8">
          ...
          <Link href={app("/spectator")} className="mt-4 inline-block text-sky-600 hover:underline">
            ← Back to matches
          </Link>
        </main>
      </>
      ...
      >
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 flex-1">
            <Link href={app("/spectator")} className="text-sm text-slate-500 hover:text-slate-700">
              ← All matches
            </Link>
            <h1
